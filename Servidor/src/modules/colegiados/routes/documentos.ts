...
documentosRouter.post('/:id',upload.single("archivo") , errorHandler(createDoc, { modulo: Modulos.COLEGIADOS, accion: Acciones.CREO }))
...
documentosRouter.put("/update/:id", errorHandler(updateDocumento, { modulo: Modulos.COLEGIADOS, accion: Acciones.MODIFICO }));
documentosRouter.delete("/delete/:id", errorHandler(deleteDocumento, { modulo: Modulos.COLEGIADOS, accion: Acciones.ELIMINO }));
