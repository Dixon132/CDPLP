 ...
 *
 * Estructura JSON estandar de intercambio entre la `Capa_Adquisicion` y la
 * `Capa_Analisis`: `{ post, comments[], image_description, hashtags[], metadata }`.
...
export const ContratoNormalizadoSchema = z.object({
    ...
    image_description: z.string(), // descripcion textual; entrada del Servicio_Vision
