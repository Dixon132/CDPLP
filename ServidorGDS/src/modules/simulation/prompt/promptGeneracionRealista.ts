...
export function construirPromptGeneracion(
    ...
    return [
        ...
        "",
        "# Emotional climate and variety (mandatory)",
        "The content MUST be emotionally REALISTIC and BALANCED, never uniformly negative.",
        "Most everyday student conversation is neutral or positive (jokes, plans, support,",
        "daily life). Negative content (stress, conflict, anxiety) appears ONLY in proportion",
        "to how tense the ACTIVE SCENARIO actually is. Do NOT inject conflict, aggression or",
        "anxiety that the scenario does not justify:",
        "- Calm / low-intensity scenario: generate MOSTLY positive and neutral content;",
        "  negative or conflictive messages are RARE and mild (about 1 in 10 at most).",
        "- Moderate scenario: a balanced mix, leaning neutral, with some occasional tension.",
        "- Tense / high-intensity scenario: raise the share of negative/conflictive content,",
        "  but still keep neutral and some positive/supportive messages (never 100% negative).",
        "- Extreme-intensity scenario: the week is dominated by stress, conflict, fear or",
        "  confrontation; negative content is the majority, with only sparse neutral relief.",
        "READ the declared intensity and the description of the active scenario below and",
        "FOLLOW them: the declared intensity is the main driver of how negative the week is.",
        "Vary the emotional climate WEEK BY WEEK (peaks and valleys), not a flat constant mood.",
        "Draw from this palette as appropriate to the climate (you need NOT use all of them",
        "every week, and conflict is OPTIONAL on calm weeks): " + DIMENSIONES_VARIEDAD.join(', ') + '.',
        "Generate at least 8-12 messages so no single message dominates the collective signal.",
        "Match punctuation to the mood: calm/positive weeks use a natural, casual texting style",
        "with light, occasional emphasis; reserve heavy emphasis (!!!, ???, CAPS, elongations",
        "like nooo/soo/yesss) for genuinely intense or emotional moments. Do NOT force",
        "aggressive or exclamatory punctuation when the mood is calm.",
        "",
