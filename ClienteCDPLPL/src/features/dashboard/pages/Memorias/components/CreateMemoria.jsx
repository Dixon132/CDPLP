...
import { createMemoria } from "../../../services/memorias";
import { Save, X } from "lucide-react";
import Alerts from "../../../components/Alerts";

const CreateMemoria = ({ onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            showAlert("error", "Error al crear el documento");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Archivo (PDF, etc.)</label>
                    <input
                        type="file"
                        name="archivo"
                        onChange={handleChange}
