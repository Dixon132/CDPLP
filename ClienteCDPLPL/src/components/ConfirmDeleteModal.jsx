...
export default function ConfirmDeleteModal({
    ...
    // ── Paso 2 ─────────────────────────────────────────────────────────────
    return (
        <Modal isOpen={true} onClose={isProcessing ? () => {} : handleClose} title={resolvedTitle}>
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
                ...
                <div className="flex items-center gap-4 mt-8 w-full justify-center">
                    <Button
                        ...
                        className="w-full max-w-[140px] disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        Cancelar
                    </Button>
                    <button
                        onClick={countdown2 === 0 && !isProcessing ? handleConfirm : undefined}
                        disabled={countdown2 > 0 || isProcessing}
                        className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg font-bold transition-all w-full max-w-[140px]
                            ${countdown2 > 0 || isProcessing
                    ...
                    >
                        ...
                        {countdown2 > 0 ? `${confirmLabel} (${countdown2}s)` : isProcessing ? "Procesando..." : confirmLabel}
                    </button>
                </div>
            </div>
        </Modal>
